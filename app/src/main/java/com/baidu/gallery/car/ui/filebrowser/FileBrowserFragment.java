package com.baidu.gallery.car.ui.filebrowser;
    ...
    private void onConfirmSelection() {
        ...
        new Thread(() -> {
            try {
                ...
                com.baidu.gallery.car.auth.BaiduAuthService authService =
                    com.baidu.gallery.car.auth.BaiduAuthService.getInstance(requireContext());
