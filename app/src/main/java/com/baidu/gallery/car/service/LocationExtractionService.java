...
public class LocationExtractionService extends IntentService {
    ...
    public static final String ACTION_EXTRACT_LOCATION = "com.baidu.gallery.car.service.action.EXTRACT_LOCATION";
    public static final String EXTRA_URL = "com.baidu.gallery.car.service.extra.URL";
    public static final String EXTRA_IS_VIDEO = "com.baidu.gallery.car.service.extra.IS_VIDEO";
    public static final String EXTRA_RECEIVER = "com.baidu.gallery.car.service.extra.RECEIVER";
